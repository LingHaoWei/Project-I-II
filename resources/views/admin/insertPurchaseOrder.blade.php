...
function myFunction() {
  ...
  cell5.innerHTML = '<button type="button" class="deleteBtn"><a href="#" class="deletePOProduct" title="Delete" data-toggle="tooltip"">Delete</a></button>';
}

function deletePOProduct() {
